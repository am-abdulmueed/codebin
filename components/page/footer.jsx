    ...
    return (
        <footer className="py-10 px-6 md:px-20 grid gap-4 lg:px-32 sm:text-center sm:place-items-center">
            ...
            <div className="flex flex-wrap gap-2 sm:justify-center">
                <a className="text-sm after:h-[2px] after:-mb-[1px] after:w-0 after:hover:w-full after:transition-all after:absolute after:left-0 after:right-0 after:bottom-0 after:bg-primary relative text-foreground/80" href="https://wa.me/9230388200384">Whatsap</a>
