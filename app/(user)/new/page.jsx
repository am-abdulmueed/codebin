                ...
                <AlertDialogContent>
                    <AlertDialogHeader className="text-left">
                        ...
                        <AlertDialogDescription>
                            ...
                            <Input id="link" className="mt-1" readOnly value={`https://am-codebin.vercel.app/s/${pubId}`} />
                            <div className="grid grid-cols-2 gap-2 mt-3">
                                <Button onClick={() => { navigator.clipboard.writeText(`https://am-codebin.vercel.app/s/${pubId}`); toast.success("Copied to clipboard!"); }}>Copy</Button>
